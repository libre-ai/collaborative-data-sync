...
`packages/core` (`@libre-ai/collab-core`, 0.1.0) and `packages/relay` (`@libre-ai/collab-relay`, 0.2.0). Each package retains its own exports and dependencies.
